...
public class User implements Serializable {
    ...
    static EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.iakk_project_war_1.0-SNAPSHOTPU");
    ...
    public String toString() {
        return "com.iakk.model.User[ id=" + id + " ]";
    }
    ...
    public User login(String email, String password) {
        ...
        try {
            StoredProcedureQuery spq = em.createNamedStoredProcedureQuery("login");
            ...
            for (Object[] o : resultList) {
                User u = new User(
                        ...
                        o[9] == null ? null : formatter.parse(o[10].toString())
                );
                toReturn = u;
            }
